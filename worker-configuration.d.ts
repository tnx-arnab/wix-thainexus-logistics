/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b3c1d3d2916a61e2e222844abc2a979)
// Runtime types generated with workerd@1.20260811.1 2026-05-23 enable_nodejs_http_modules,enable_nodejs_http_server_modules,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	SPI_DEADLINE_MS: "0";
	WIX_SPI_FAST_MS: "8500";
	...
	THAI_NEXUS_FUNCTIONS_URL: string;
	THAI_NEXUS_TIMEOUT_MS: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./api/src/worker");
	}
